  ...
  return (
    <AppLayout searchPlaceholder="Search suppliers...">
      <div className="content-header">
        <h1>Supplier Relationship Hub</h1>
        <p>Manage your supplier network and track relationships from first contact to completed deals</p>
      </div>
      ...
      <div className="quick-actions">
        <h2>Manage Your Supplier Network</h2>
        <p>Add new suppliers, contact existing ones, and maintain your trusted network</p>
